...
describe('работа кнопки "Активные" для фильтрации клиентов компании в случае дефолтного/нефильтрованного состояния списка', () => {
	beforeAll(() => {
	...
	test('показать всех "активных" клиентов при первом нажатии на кнопку', () => {
	...
	test('показать всех "активных" клиентов при повторном нажатии на кнопку', () => {
		// нажимаем на кнопку "Активные" повторно
		ReactTestUtils.Simulate.click(activeClientsBtn);
...
describe('работа кнопки "Активные" для фильтрации клиентов компании в случае модифицированного/фильтрованного состояния списка', () => {
	beforeAll(() => {
